...
public class I18n {
    ...
    private static void initAR() {
        ...
        AR.put("msg.shop_not_found", "\u00a7cلم يتم العثور على NPC المتجر الخاص بك. استخدم \u00a7a/shop create \u00a7cلإنشائه مرة أخرى. \u00a77عروضك محفوظة.");
        ...
        AR.put("msg.shop_list_item", "\u00a7a\u25b6 \u00a7fمتجر %s \u00a7c(%d عرض)");
        AR.put("msg.shop_deleted_admin", "\u00a7aتم حذف المتجر لـ: \u00a7e%s");
        ...
        AR.put("msg.skin_not_found", "\u00a7e\u26a0 \u00a7cلم تقم بوضع صورة السكن الخاصة بك PNG في {path}\u00a7c. سيهر وجهك بشكل افتراضي في قائمة المتاجر حتى تضيفها.");
        AR.put("skin.click_to_open", "\u00a7eاضغط لفتح المجلد");

        AR.put("storage.title", "مخزن - %s");
        AR.put("storage.page", "صفحة %d/%d | %d عناصر");
        AR.put("storage.empty", "المخزن فارغ");

        AR.put("picker.title", "اختر عنصر السعر");
        AR.put("picker.search", "بحث...");
        AR.put("picker.page_info", "صفحة %d/%d | %d عناصر");
        AR.put("picker.back", "رجوع");

        AR.put("amount.title", "تحديد الكمية");
        AR.put("amount.enter", "أدخل الكمية كسعر:");
    ...
    private static void initZH() {
        ...
        ZH.put("shop.no_offers", "还没有商品");
        ZH.put("shop.page", "第 %d/%d 页");
        ZH.put("shop.items", "%d 个物品");
        ZH.put("shop.add_buyable", "添加可购买物品:");
        ...
        ZH.put("msg.shop_exists", "\u00a7c你已经有一个商店了! 使用 \u00a7e/shop close \u00a7c先删除它。");
        ZH.put("msg.shop_closed", "\u00a7a商店已成功关闭! \u00a77(你的物品已保存)");
        ZH.put("msg.shop_not_found", "\u00a7c找不到你的商店NPC。使用 \u00a7a/shop create \u00a7c重新创建。 \u00a77你的商品仍然保存着。");
        ZH.put("msg.shop_npc_not_found", "\u00a7c你没有商店!");
        ZH.put("msg.shop_npc_killed", "\u00a7c\u2620 \u00a7e%s\u00a7c的商店被 \u00a7e%s\u00a7c 摧毁了! 商品仍然保存着。");
        ZH.put("msg.shop_not_exists", "\u00a7c商店 \u00a7e%s \u00a7c未找到!");
        ZH.put("msg.no_shops", "\u00a77还没有商店。");
        ZH.put("msg.shop_list_header", "\u00a76\u2500\u2500\u2500\u2500\u2500\u2500\u2500 商店列表 \u2500\u2500\u2500\u2500\u2500\u2500\u2500");
        ZH.put("msg.shop_list_item", "\u00a7a\u25b6 \u00a7f%s的商店 \u00a7c(%d 个商品)");
        ZH.put("msg.shop_deleted_admin", "\u00a7a已为以下玩家删除商店: \u00a7e%s");
        ...
        ZH.put("msg.not_enough_items", "\u00a7c你需要 \u00a7e%d %s\u00a7c! 你有 \u00a7e%d");
        ZH.put("msg.not_enough_money", "\u00a7c你需要 \u00a7e%d\u00a7c 个 \u00a7c%s \u00a7c- 你有 \u00a7e%d");

        ZH.put("msg.trade_success", "\u00a7a交易完成! 你获得了 \u00a7f%s");
        ZH.put("msg.trade_item_taken", "\u00a7a拿走了 \u00a7f%s \u00a7ax%d");
        ZH.put("msg.inventory_full", "\u00a7c背包已满!");
        ZH.put("msg.skin_not_found", "\u00a7e\u26a0 \u00a7c你没有把皮肤PNG放在 {path}\u00a7c。在添加之前，你的头像将显示为默认图像。");
        ZH.put("skin.click_to_open", "\u00a7e点击打开文件夹");

        ZH.put("storage.title", "仓库 - %s");
        ZH.put("storage.page", "第 %d/%d 页 | %d 个物品");
        ZH.put("storage.empty", "仓库是空的");
        ...
        ZH.put("buyer.empty", "商店是空的");
        ZH.put("buyer.buy", "购买");
        ZH.put("buyer.details", "详情");
        ZH.put("buyer.no_trades", "没有可用的交易");
        ...
        ZH.put("select.hint", "左键: 拿起/放置全部 | 右键: 分割/放置一个");

        ZH.put("msg.target_has_shop", "\u00a7c该玩家已经拥有一个商店! 不能拥有多个商店。");
        ZH.put("msg.shop_deleted_notify", "\u00a7c你的商店已被删除。输入 \u00a7e/shop recover \u00a7c来恢复你的物品。");
        ZH.put("msg.no_recovery_items", "\u00a7c没有可恢复的物品。");
        ZH.put("msg.all_recovered", "\u00a7a你所有的物品都已恢复!");
        ZH.put("msg.recovery_inventory_full", "\u00a7c背包已满! 腾出空间后再试。");
        ZH.put("msg.admin_only", "\u00a7c该命令仅限管理员使用!");
        ZH.put("msg.transfer_success", "\u00a7a商店所有权转移成功!");
        ZH.put("msg.repair_success", "\u00a7a商店所有权修复成功!");
        ZH.put("msg.shop_not_found_admin", "\u00a7c未找到玩家的商店: \u00a7e%s");
        ZH.put("msg.no_shops_without_uuid", "\u00a77未找到没有UUID的商店 (全部已链接)。");
    ...
    private static void initJA() {
        ...
        JA.put("shop.set_price", "価格を設定");
        JA.put("shop.add_offer", "商品を追加");
        JA.put("shop.close", "閉じる");
        JA.put("shop.open", "開く");
        JA.put("shop.sell_item", "販売するアイテム:");
        ...
        JA.put("shop.add_buyable", "購入可能なアイテムを追加:");
        ...
        JA.put("shoplist.empty", "まだショップがありません");
        JA.put("shoplist.count", "%d 個のショップ");
        JA.put("shoplist.shop_of", "%sのショップ");
        JA.put("shoplist.offer_single", "(%d 個の商品)");
        JA.put("shoplist.offer_plural", "(%d 個の商品)");

        JA.put("msg.shop_created", "\u00a7aショップを作成しました: \u00a7e%sのショップ \u00a7a\u00a7r");
        JA.put("msg.shop_exists", "\u00a7cすでにショップを持っています! \u00a7e/shop close \u00a7cで先に削除してください。");
        JA.put("msg.shop_closed", "\u00a7aショップを正常に閉じました! \u00a77(アイテムは保存されています)");
        JA.put("msg.shop_not_found", "\u00a7cショップNPCが見つかりません。 \u00a7a/shop create \u00a7cで再作成してください。 \u00a77商品はまだ保存されています。");
        JA.put("msg.shop_npc_not_found", "\u00a7cショップを持っていません!");
        JA.put("msg.shop_npc_killed", "\u00a7c\u2620 \u00a7e%s\u00a7cのショップが \u00a7e%s\u00a7c によって破壊されました! 商品はまだ保存されています。");
        JA.put("msg.shop_not_exists", "\u00a7cショップ \u00a7e%s \u00a7cが見つかりません!");
        JA.put("msg.no_shops", "\u00a77まだショップがありません。");
        JA.put("msg.shop_list_header", "\u00a76\u2500\u2500\u2500\u2500\u2500\u2500\u2500 ショップリスト \u2500\u2500\u2500\u2500\u2500\u2500\u2500");
        JA.put("msg.shop_list_item", "\u00a7a\u25b6 \u00a7f%sのショップ \u00a7c(%d 個の商品)");
        JA.put("msg.shop_deleted_admin", "\u00a7a次のプレイヤーのショップを削除しました: \u00a7e%s");

        JA.put("msg.offer_added", "\u00a7a商品を追加しました!");
        JA.put("msg.offer_removed", "\u00a7a商品を削除しました!");
        JA.put("msg.offer_returned_storage", "\u00a7eインベントリが満杯のため、アイテムをストレージに移動しました!");
        JA.put("msg.offer_returned_inventory", "\u00a7aアイテムをインベントリに戻しました!");

        JA.put("msg.select_item", "\u00a7c先に販売するアイテムを選択してください!");
        JA.put("msg.select_price", "\u00a7c先に価格を設定してください!");
        ...
        JA.put("msg.trade_item_taken", "\u00a7a\u00a7f%s \u00a7ax%dを取得しました");
        JA.put("msg.inventory_full", "\u00a7cインベントリが満杯です!");
        JA.put("msg.skin_not_found", "\u00a7e\u26a0 \u00a7cスキンPNG画像を {path}\u00a7c に配置していません。追加するまで、ショップリストではデフォルトの顔が表示されます。");
        JA.put("skin.click_to_open", "\u00a7eクリックしてフォルダを開く");
        ...
        JA.put("buyer.no_trades", "利用可能な取引がありません");
        JA.put("buyer.offers_count", "商品: %d");
        JA.put("buyer.you_get", "獲得:");
        JA.put("buyer.you_pay", "支払い:");
        JA.put("buyer.quantity", "数量: %d");
        JA.put("buyer.for", "と引き換え");

        JA.put("select.title", "アイテムを選択");
        JA.put("select.inventory", "インベントリ");
        JA.put("select.hotbar", "ホットバー");
        JA.put("select.sell", "販売");
        JA.put("select.hint", "左: すべて取得/配置 | 右: 分割/1個配置");

        JA.put("msg.target_has_shop", "\u00a7cこのプレイヤーはすでにショップを持っています! 複数のショップを持つことはできません。");
        JA.put("msg.shop_deleted_notify", "\u00a7cあなたのショップは削除されました。 \u00a7e/shop recover \u00a7cと入力してアイテムを復元してください。");
        JA.put("msg.no_recovery_items", "\u00a7c復元するアイテムがありません。");
        JA.put("msg.all_recovered", "\u00a7aすべてのアイテムを復元しました!");
        JA.put("msg.recovery_inventory_full", "\u00a7cインベントリが満杯です! スペースを空けて再試行してください。");
        JA.put("msg.admin_only", "\u00a7cこのコマンドは管理者専用です!");
        JA.put("msg.transfer_success", "\u00a7aショップの所有権を正常に移転しました!");
        JA.put("msg.repair_success", "\u00a7aショップの所有権を正常に修復しました!");
        JA.put("msg.shop_not_found_admin", "\u00a7cプレイヤーのショップが見つかりません: \u00a7e%s");
        JA.put("msg.no_shops_without_uuid", "\u00a77UUIDのないショップは見つかりませんでした (すべてリンク済み)。");
        JA.put("msg.player_not_found", "\u00a7cプレイヤーが見つかりません: \u00a7e%s");
        JA.put("msg.no_shop_to_transfer", "\u00a7cプレイヤー \u00a7e%s \u00a7cはショップを持っていません!");
        JA.put("recovery.title", "アイテム復元");
    }

    // ==================== Korean (ko_kr) ====================
    private static void initKO() {
        KO.put("shop.title", "%s - 상점 관리");
        KO.put("shop.storage", "창고");
        KO.put("shop.set_price", "가격 설정");
        KO.put("shop.add_offer", "상품 추가");
        KO.put("shop.close", "닫기");
        KO.put("shop.open", "열기");
        KO.put("shop.sell_item", "판매할 아이템:");
        KO.put("shop.price", "가격:");
        KO.put("shop.offers", "상품");
        KO.put("shop.no_offers", "아직 상품이 없습니다");
        KO.put("shop.page", "%d/%d 페이지");
        KO.put("shop.items", "%d개 아이템");
        KO.put("shop.add_buyable", "구매 가능한 아이템 추가:");
        ...
        KO.put("shoplist.empty", "아직 상점이 없습니다");
        ...
        KO.put("msg.shop_exists", "\u00a7c이미 상점이 있습니다! \u00a7e/shop close \u00a7c로 먼저 삭제하세요.");
        KO.put("msg.shop_closed", "\u00a7a상점이 성공적으로 닫혔습니다! \u00a77(아이템이 저장되었습니다)");
        KO.put("msg.shop_not_found", "\u00a7c상점 NPC를 찾을 수 없습니다. \u00a7a/shop create \u00a7c로 다시 생성하세요. \u00a77상품은 여전히 저장되어 있습니다.");
        KO.put("msg.shop_npc_not_found", "\u00a7c상점이 없습니다!");
        KO.put("msg.shop_npc_killed", "\u00a7c\u2620 \u00a7e%s\u00a7c의 상점이 \u00a7e%s\u00a7c에 의해 파괴되었습니다! 상품은 여전히 저장되어 있습니다.");
        KO.put("msg.shop_not_exists", "\u00a7c상점 \u00a7e%s \u00a7c을(를) 찾을 수 없습니다!");
        KO.put("msg.no_shops", "\u00a77아직 상점이 없습니다.");
        KO.put("msg.shop_list_header", "\u00a76\u2500\u2500\u2500\u2500\u2500\u2500\u2500 상점 목록 \u2500\u2500\u2500\u2500\u2500\u2500\u2500");
        KO.put("msg.shop_list_item", "\u00a7a\u25b6 \u00a7f%s의 상점 \u00a7c(%d개 상품)");
        KO.put("msg.shop_deleted_admin", "\u00a7a다음 플레이어의 상점을 삭제했습니다: \u00a7e%s");

        KO.put("msg.offer_added", "\u00a7a상품이 추가되었습니다!");
        KO.put("msg.offer_removed", "\u00a7a상품이 제거되었습니다!");
        KO.put("msg.offer_returned_storage", "\u00a7e인벤토리가 가득 차서 아이템을 창고로 이동했습니다!");
        ...
        KO.put("msg.not_enough_items", "\u00a7c\u00a7e%d %s\u00a7c이(가) 필요합니다! 보유: \u00a7e%d");
        KO.put("msg.not_enough_money", "\u00a7c\u00a7e%d\u00a7c개의 \u00a7c%s \u00a7c이(가) 필요합니다 - 보유: \u00a7e%d");

        KO.put("msg.trade_success", "\u00a7a거래 완료! \u00a7f%s을(를) 획득했습니다");
        KO.put("msg.trade_item_taken", "\u00a7a\u00a7f%s \u00a7ax%d을(를) 획득했습니다");
        KO.put("msg.inventory_full", "\u00a7c인벤토리가 가득 찼습니다!");
        KO.put("msg.skin_not_found", "\u00a7e\u26a0 \u00a7c스킨 PNG 이미지를 {path}\u00a7c 에 넣지 않았습니다. 추가할 때까지 상점 목록에서 기본 프로필 이미지가 표시됩니다.");
        KO.put("skin.click_to_open", "\u00a7e클릭하여 폴더 열기");

        KO.put("storage.title", "창고 - %s");
        KO.put("storage.page", "%d/%d 페이지 | %d개 아이템");
        KO.put("storage.empty", "창고가 비어 있습니다");
        ...
        KO.put("amount.enter", "가격으로 수량을 입력:");
        ...
        KO.put("buyer.no_trades", "사용 가능한 거래가 없습니다");
        KO.put("buyer.offers_count", "상품: %d");
        KO.put("buyer.you_get", "획득:");
        KO.put("buyer.you_pay", "지불:");
        KO.put("buyer.quantity", "수량: %d");
        KO.put("buyer.for", "대가로");

        KO.put("select.title", "아이템 선택");
        KO.put("select.inventory", "인벤토리");
        KO.put("select.hotbar", "핫바");
        KO.put("select.sell", "판매");
        KO.put("select.hint", "좌클릭: 모두 집기/놓기 | 우클릭: 나누기/하나 놓기");

        KO.put("msg.target_has_shop", "\u00a7c이 플레이어는 이미 상점을 가지고 있습니다! 하나 이상의 상점을 소유할 수 없습니다.");
        KO.put("msg.shop_deleted_notify", "\u00a7c상점이 삭제되었습니다. \u00a7e/shop recover \u00a7c를 입력하여 아이템을 복구하세요.");
        KO.put("msg.no_recovery_items", "\u00a7c복구할 아이템이 없습니다.");
        KO.put("msg.all_recovered", "\u00a7a모든 아이템이 복구되었습니다!");
        KO.put("msg.recovery_inventory_full", "\u00a7c인벤토리가 가득 찼습니다! 공간을 확보하고 다시 시도하세요.");
        KO.put("msg.admin_only", "\u00a7c이 명령은 관리자 전용입니다!");
        ...
        KO.put("msg.no_shops_without_uuid", "\u00a77UUID가 없는 상점을 찾을 수 없습니다 (모두 이미 연결됨).");
        KO.put("msg.player_not_found", "\u00a7c플레이어를 찾을 수 없습니다: \u00a7e%s");
        KO.put("msg.no_shop_to_transfer", "\u00a7c플레이어 \u00a7e%s \u00a7c은(는) 상점이 없습니다!");
