...
public class EnchantedBookAmountScreen extends Screen {
    ...
    public void render(DrawContext ctx, int mx, int my, float delta) {
        ...
        ctx.drawItem(bookTemplate, px+W/2-8, py+34);
        
        // Draw book name
        ctx.drawCenteredTextWithShadow(textRenderer, bookTemplate.getName(), px+W/2, py+60, 0xFFFFFFFF);
